...
const AddPizza = () => {
    ...
    function viewpizzas(dish) {
        console.log(dish);
        setoldDishName(dish.name);
        setName(dish.name);
        setUrl(dish.pictureURL);
        setPrice23(dish.dishSizeModels[0].price);
        setPrice30(dish.dishSizeModels[1].price);
        setPrice35(dish.dishSizeModels[2].price);

    }


    async function updateNewPizza(event) {
                        ...
                        <div className="list-container-ing">
                            {
                                dishes.map((dish, index) =>
                                    <div key={index}>
                                        <button onClick={() => {
                                            viewpizzas(dish)}}>{dish.name}</button>
                                    </div>
                                )
                            }
                        </div>
            ...
            <section>
                <form onSubmit={updateNewPizza}>
                    <div className="addPizza">
                        ...
                        <br />
                        <button className="addButton" type={"submit"}>Изменить</button>
                    </div>
                </form>
            </section>
        </div>
